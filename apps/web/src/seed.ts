...
export const SEED_THREATS: Threat[] = [
  {
    ...
    severity: 0.55,
    physical: { kind: 'transit_decline_fraction', value: 0.55 },
    start: NOW, months: 4,
  ...
  },
  {
    ...
    category: 'export_ban',
    kind: 'geopolitical',
    location: { lat: 22.0, lng: 79.0, admin: 'India', iso3: 'IND', regionId: 'india-rice' },
    commodities: [ { id: 'rice', relevance: 1 } ],
    severity: 0.8,
    physical: { kind: 'import_share_blocked', value: 0.8 },
    start: NOW, months: 6,
  ...
  },
  {
    ...
    severity: 1,
    physical: { kind: 'tariff_rate', value: 0.25 },
    start: NOW, months: 12,
  ...
  },
  {
    ...
    category: 'war',
    kind: 'geopolitical',
    location: { lat: 48.0, lng: 35.0, admin: 'Ukraine / Russia', iso3: 'UKR', regionId: 'black-sea' },
  ...
  },
  {
    ...
    severity: 0.4,
    physical: { kind: 'transit_decline_fraction', value: 0.4 },
    start: NOW, months: 4,
